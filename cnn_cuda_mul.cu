...
void cnn(float *images, float **network, int *labels, float *confidences, int num_images, int batch_size) {
    ...
    for(int i = start_num_images; i < num_images; i += batchImg)
    {
        ...
        /*convolution_layer_v2(image, c1_1_seq, w1_1, b1_1, 64, 3, 32);
        convolution_layer_v2(c1_1_seq, c1_2_seq, w1_2, b1_2, 64, 64, 32);
        pooling_layer(c1_2_seq, p1_seq, 64, 16);

        convolution_layer_v2(p1_seq, c2_1_seq, w2_1, b2_1, 128, 64, 16);
        convolution_layer_v2(c2_1_seq, c2_2_seq, w2_2, b2_2, 128, 128, 16);
        pooling_layer(c2_2_seq, p2_seq, 128, 8);

        convolution_layer_v2(p2_seq, c3_1_seq, w3_1, b3_1, 256, 128, 8);
        convolution_layer_v2(c3_1_seq, c3_2_seq, w3_2, b3_2, 256, 256, 8);
        convolution_layer_v2(c3_2_seq, c3_3_seq, w3_3, b3_3, 256, 256, 8);
        pooling_layer(c3_3_seq, p3_seq, 256, 4);

        convolution_layer_v2(p3_seq, c4_1_seq, w4_1, b4_1, 512, 256, 4);
        convolution_layer_v2(c4_1_seq, c4_2_seq, w4_2, b4_2, 512, 512, 4);
        convolution_layer_v2(c4_2_seq, c4_3_seq, w4_3, b4_3, 512, 512, 4);
        pooling_layer(c4_3_seq, p4_seq, 512, 2);

        convolution_layer_v2(p4_seq, c5_1_seq, w5_1, b5_1, 512, 512, 2);
        convolution_layer_v2(c5_1_seq, c5_2_seq, w5_2, b5_2, 512, 512, 2);
        convolution_layer_v2(c5_2_seq, c5_3_seq, w5_3, b5_3, 512, 512, 2);
        pooling_layer(c5_3_seq, p5_seq, 512, 1);

        fc_layer(p5_seq, fc1_seq, w1, b1, 512, 512);
        fc_layer(fc1_seq, fc2_seq, w2, b2, 512, 512);
        fc_layer(fc2_seq, fc3_seq, w3, b3, 10, 512);

        float checksum_cuda = 0; float checksum_seq = 0;
        for (int j = 0; j < 512*2*2; j++) {
            checksum_seq += c5_2_seq[j];
        }*/
