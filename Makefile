...
cuda_mul_v2: main.cu cnn_cuda_mul_v2.cu timer.cu
	nvcc -o cnn_cuda_mul_v2 main.cu cnn_cuda_mul_v2.cu timer.cu
...
clean:
	rm -f main.o timer.o cnn_seq cnn_cuda cnn_cuda_mul cnn_cuda_mul_v2 result*.out
